...
const Shuffle: React.FC<ShuffleProps> = ({
    ...
    threshold = 0.1,
    rootMargin = '-100px',
    tag: Tag = 'p' as React.ElementType,
    textAlign = 'center',
    onShuffleComplete,
    shuffleTimes = 1,
        ...
        () => {
            ...
            const randomizeScrambles = () => {
                ...
                wrappersRef.current.forEach(w => {
                    ...
                    for (let _i = 1; _i < kids.length - 1; _i++) {
                        kids[_i].textContent = scrambleCharset.charAt(Math.floor(Math.random() * scrambleCharset.length));
                    }
                });
            };
            ...
            const play = () => {
                ...
                const addTween = (targets: HTMLElement[], at: string | number) => {
                    const vars: any = {
                        duration,
                        ease,
                        force3D: true,
                ...
                if (animationMode === 'evenodd') {
                    const odd = strips.filter((_v, i) => i % 2 === 1);
                    const even = strips.filter((_v, i) => i % 2 === 0);
