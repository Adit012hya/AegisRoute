    ...
    useEffect(() => {
        ...
        class MouseClass {
            ...
            init(container: HTMLElement) {
                ...
                this.listenerTarget.addEventListener('mousemove', this._onMouseMove as any);
                ...
                this.listenerTarget.addEventListener('touchend', this._onTouchEnd as any);
                if (this.docTarget) {
                    this.docTarget.addEventListener('mouseleave', this._onDocumentLeave as any);
                }
            }
            dispose() {
                if (this.listenerTarget) {
                    this.listenerTarget.removeEventListener('mousemove', this._onMouseMove as any);
                    ...
                    this.listenerTarget.removeEventListener('touchend', this._onTouchEnd as any);
                }
                if (this.docTarget) {
                    this.docTarget.removeEventListener('mouseleave', this._onDocumentLeave as any);
                }
...
`;
        ...
        class Advection extends ShaderPass {
            ...
            updateProp({ dt, isBounce, BFECC }: { dt: number; isBounce: boolean; BFECC: boolean }) {
        ...
        class ExternalForce extends ShaderPass {
            ...
            override init(..._args: any[]) {
                const simProps = _args[0];
                super.init();
        ...
        class Viscous extends ShaderPass {
            ...
            updateProp({ viscous, iterations, dt }: { viscous: number; iterations: number; dt: number }) {
                let fbo_in, fbo_out;
                if (!this.uniforms) return;
        ...
        class Poisson extends ShaderPass {
            ...
            updateProp({ iterations }: { iterations: number }) {
                let p_in, p_out;
                if (!this.uniforms) return;
                for (let i = 0; i < iterations; i++) {
                    if (i % 2 === 0) {
        ...
        class Pressure extends ShaderPass {
            ...
            updateProp({ vel, pressure }: { vel: any; pressure: any }) {
                if (!this.uniforms) return;
                this.uniforms.velocity.value = vel.texture;
        ...
        class Simulation {
            ...
            update() {
                ...
                this.advection.updateProp({
                    dt: this.options.dt,
                    isBounce: this.options.isBounce,
                    BFECC: this.options.BFECC
                });
                this.externalForce.updateProp({
                    cursor_size: this.options.cursor_size,
                ...
                if (this.options.isViscous) {
                    vel = this.viscous.updateProp({
                        viscous: this.options.viscous,
                        iterations: this.options.iterations_viscous,
                        dt: this.options.dt
                    });
                }
                this.divergence.updateProp({ vel });
                const pressure = this.poisson.updateProp({
                    iterations: this.options.iterations_poisson
                });
                this.pressure.updateProp({ vel, pressure });
            }
        }
